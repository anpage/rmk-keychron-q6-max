...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        ...
        layer!([
            ...
            [k!(Grave),    k!(Kb1),            k!(Kb2),          k!(Kb3),   k!(Kb4),   k!(Kb5),   k!(Kb6),     k!(Kb7),            k!(Kb8),       k!(Kb9),            k!(Kb0),       k!(Minus),        k!(Equal),        k!(Backspace), k!(Insert),  k!(Home),   k!(PageUp),   k!(NumLock), k!(KpSlash),   k!(KpAsterisk)],
