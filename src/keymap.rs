...
pub const fn get_default_keymap() -> [[[KeyAction; COL]; ROW]; NUM_LAYER] {
    [
        ...
        layer!([
            [k!(Escape),      k!(BrightnessDown), k!(BrightnessUp),  k!(MissionControl), k!(Launchpad),      k!(BacklightDown),      k!(BacklightUp),   k!(MediaPrevTrack), k!(MediaPlayPause), k!(MediaNextTrack), k!(AudioMute),   k!(AudioVolDown), k!(AudioVolUp),   k!(AudioMute),   a!(No/*Screenshot*/), a!(No/*Siri*/),  k!(RgbModeForward), k!(F13),         k!(F14),         k!(F15)       ],
        ...
        layer!([
            ...
            [k!(RgbTog),      k!(RgbModeForward), k!(BacklightUp),   a!(No/*Hue+*/),     a!(No/*Sat+*/),     a!(No/*EffectSpeed+*/), a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(Transparent),  a!(Transparent), a!(Transparent),      a!(Transparent), a!(Transparent),    a!(Transparent), a!(Transparent), a!(Transparent)],
            [a!(Transparent), k!(RgbModeReverse), k!(BacklightDown), a!(No/*Hue-*/),     a!(No/*Sat-*/),     a!(No/*EffectSpeed-*/), a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(Transparent),  a!(Transparent), a!(Transparent),      a!(Transparent), a!(Transparent),    a!(Transparent), a!(Transparent), a!(Transparent)],
        ...
        layer!([
            [a!(Transparent), k!(BrightnessDown), k!(BrightnessUp),  a!(No/*TaskView*/), a!(No/*Explorer*/), k!(BacklightDown),      k!(BacklightUp),   k!(MediaPrevTrack), k!(MediaPlayPause), k!(MediaNextTrack), k!(AudioMute),   k!(AudioVolDown), k!(AudioVolUp),   k!(RgbTog),      a!(Transparent),      a!(Transparent), k!(RgbTog),         a!(Transparent), a!(Transparent), a!(Transparent)],
            [a!(Transparent), k!(No/*BtHost1*/),  a!(No/*BtHost2*/), a!(No/*BtHost3*/),  a!(No/*2.4GHz*/),   a!(Transparent),        a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(Transparent),  a!(Transparent), a!(Transparent),      a!(Transparent), a!(Transparent),    a!(Transparent), a!(Transparent), a!(Transparent)],
            [k!(RgbTog),      k!(RgbModeForward), k!(BacklightUp),   a!(No/*Hue+*/),     a!(No/*Sat+*/),     a!(No/*EffectSpeed+*/), a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(Transparent),  a!(Transparent), a!(Transparent),      a!(Transparent), a!(Transparent),    a!(Transparent), a!(Transparent), a!(Transparent)],
            [a!(Transparent), k!(RgbModeReverse), k!(BacklightDown), a!(No/*Hue-*/),     a!(No/*Sat-*/),     a!(No/*EffectSpeed-*/), a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(Transparent),  a!(Transparent), a!(Transparent),      a!(Transparent), a!(Transparent),    a!(Transparent), a!(Transparent), a!(Transparent)],
            [a!(Transparent), a!(No),             a!(Transparent),   a!(Transparent),    a!(Transparent),    a!(Transparent),        a!(No/*BattLvl*/), a!(Transparent),    a!(Transparent),    a!(Transparent),    a!(Transparent), a!(Transparent),  a!(No),           a!(Transparent), a!(No),               a!(Transparent), a!(No),             a!(Transparent), a!(Transparent), a!(Transparent)],
